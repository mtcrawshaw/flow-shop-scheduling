...
def test_get_maximum_points_small():
    """
    Test Schedule.get_maximum_points() for a small example.
    """
    ...
    assert schedule.get_maximum_points() == 4.25


def test_get_maximum_points_empty():
    """
    Test Schedule.get_maximum_points() for an empty schedule.
    """

    schedule = Schedule("test", [])
    assert schedule.get_maximum_points() == 0.0
